...
### 4. GetCobrosReferenciados
- **Ruta:** `GET https://localhost:44399/credit/GetCobrosReferenciados/{bp}`
- **Parámetros en URL:**
  - `bp`: String
...
> [!success] Response (OData WACOBREFSet)
> ```json
> [
>   {
>     "Mandt": "110",
>     "Zidcobreftmp": 3,
>     "Zreferencia": "20260317141004",
>     "Zusuario": "USR02",
>     "Bp": "1500004810",
>     "Vbeln": "9000005860",
>     "Auart": "ZMER",
>     "Zmonto": "500.000",
>     "Zfecharegistro": "2025-09-18T00:00:00",
>     "Zfechaconclusion": null,
>     "Zestatus": "P",
>     "Zbanco": "STP"
>   }
> ]
...
### 5. GetClabeSTP
- **Ruta:** `GET https://localhost:44399/credit/GetClabeSTP/{bp}`
- **Parámetros en URL:**
  - `bp`: String
...
> [!success] Response (OData WACTACLBSTPSet)
> ```json
> [
>   {
>     "Mandt": "110",
>     "Zidctasclbstp": "0000000001",
>     "Bp": "1500000003",
>     "Zcuentaclabestp": "646180248300000011",
>     "Zfechaasignacion": "/Date(1785715200000)/",
>     "Zhoraasignacion": "PT11H15M51S",
>     "Zusuario": "SIS",
>     "Zfecharegisto": "/Date(1728259200000)/",
>     "Zhoraregisto": "PT09H12M42S",
>     "Zasignado": "1",
>     "Zfechacambio": null,
>     "Zhoracambio": "PT00H00M00S",
>     "Zusuariocambio": ""
>   }
> ]
> ```
...
### 7. EnableChannelOrg
- **Ruta:** `POST https://localhost:44399/partner/enablechanelorg`

> [!abstract] Request Body (`BpCombinationRequest`)
> ```json
> {
>   "Bp": "9400",
>   "Vkorg": "04",
...
> ```json
> {
>   "message": "Combinación habilitada exitosamente"
> }
> ```
