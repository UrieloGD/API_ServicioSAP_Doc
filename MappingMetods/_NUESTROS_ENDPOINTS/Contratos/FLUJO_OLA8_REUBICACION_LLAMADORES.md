...
| 2 | `mage.deletePromociones()` | 🟦 E-23 | DMZ → Magento | *ninguna* — vacía las categorías `OUTLET` en Magento |
...
La tocan E-19 (tramo 3) y el llamador de `getOrderId`, más todo el bloque 🟥 del importador
