...
> 🗑️ **Descartado el 31 ago: `recommender/setRecommenderList`.** Mismo criterio — pierde su identificador y los posteriores se reindexan una posición. La serie vigente es **E-01 a E-47** sin huecos.
...
|---|---|---|---|---:|---|
| E-44 | `credit/SolicitudMercancia` | `partner/client/{clientId}` | `ServicioAndroid` | 1.0 | — |
| E-45 | `credit/codigoPromocion` | SuccessFactors + BP05 | **SIGMAVI** `VentaCupon` | 1.5 | — |
...
> 🔒 **E-47 está bloqueado.** La tabla la alimenta PCP y **Miguel Marín** debe entregar la estructura. Al recibirla, verificar que conserve `TipoGarantia`, `Marca`, `Telefono`, `Proveedor`, `Linea`.
...
|---|---|---|---|
| 1 | **Estructura de garantías (Miguel Marín)** | E-47 no arranca | Solicitar antes del 1 de septiembre |
