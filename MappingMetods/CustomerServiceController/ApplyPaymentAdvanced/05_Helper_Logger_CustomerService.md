...
## Puntos de Invocación en este Flujo (ApplyPaymentAdvanced)

| Método | Momento | `type` | Contenido de `message` |
|---|---|---|---|
| `CustomerServiceMethods.ApplyPaymentAdvanced` | Al iniciar el método | `"ApplyPayment Request() => "` | JSON del request completo |
| `CustomerServiceMethods.ApplyPaymentAdvanced` | En catch general | `"ERROR ApplyPayment() => "` | Mensaje de excepción |
