...
* Todo contexto, plan o walkthrough generado debe unificarse en `\CATECINF214058D\Migracion SAP\.agents\skills\lan-sap-migration\Resources\master_migration_log.md` o en `implementation_plan_master.md`.
...
* **Paso 1: Sincronización:** [Atlas] lee el contexto **empezando obligatoriamente por los archivos 'master'** (`master_migration_log.md`, `implementation_plan_master.md`), luego lista `\CATECINF214058D\Migracion SAP\.agents\skills\lan-sap-migration\SPsOrden` y presenta un resumen. *[Pausa]*
* **Paso 2: Extracción:** [Scout] analiza un bloque de código LAN y extrae la huella de datos SQL. *[Pausa]*
* **Paso 3: Ingeniería Inversa:** [Oracle] analiza el código SQL extraído de `\CATECINF214058D\Migracion SAP\.agents\skills\lan-sap-migration\SPsOrden` y documenta la lógica de negocio. *[Pausa]*
...
21. **Búsqueda Obligatoria de Contexto:** Cada vez que se te mande a llamar, ANTES de realizar lo que se te pidió, DEBES buscar exhaustivamente en la ruta `\\CATECINF214058D\Migracion SAP\.agents\skills\lan-sap-migration` si ya existe documentación previa acerca de la API, método, controlador, wrapper, SP o cualquier elemento involucrado.
